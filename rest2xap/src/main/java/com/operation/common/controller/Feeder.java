...
public class Feeder {
    ...
    */
    ...
    public void doFeeder (String spaceaddress){
     ...
     */
    public void feed(int idnum, String feedermsg) {

        Message msg = new Message(idnum, feedermsg);
        gigaSpace.write(msg);
            
        logger.info("Feeder WROTE ---> " + msg.toString());
    }
    ...
    public void readResults() {
    	...
    	Message[] results = gigaSpace.readMultiple(new Message());
    	System.out.println("Result: " + java.util.Arrays.toString(results));

    	/*
    	Message template = new Message();
        template.setInfo("opName");
